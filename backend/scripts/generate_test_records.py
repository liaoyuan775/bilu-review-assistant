...
RECORDS = [
    ...
    InquiryRecord(
        ...
        questions=[
            ("请说明你的姓名、性别、年龄、民族、身份证号码、工作单位、住址和联系电话。", "我叫赵测试，女，68岁，汉族，身份证号码110101195804120048，联系电话13600000006，是测试市示范小学退休教师，现住测试省测试市演示区银龄街40号401室。以上均为虚构测试信息。"),
            ("是否听清权利义务告知，是否申请回避？", "我已经听清，不申请回避。"),
            ("请从接到电话开始按时间顺序讲述事情经过。", "2026年7月13日9时18分，我独自在家使用测试手机TEST-PHONE-004接到号码17000000004的电话。对方自称测试市公安局刑侦支队民警，说我的银行卡涉及洗钱，随后让我通过会议软件接受视频询问，并要求我对家人保密。"),
            ("对方使用了什么身份、账号和联系方式？", "第一名男子自称陈警官，虚构警号TEST-J004，来电号码17000000004；第二名女子自称测试检察院刘检察官，会议账号meeting_police_test_004。两人都只在电话和视频中出现。"),
            ("对方向你展示了什么材料，提出了什么要求？", "对方通过视频展示带有我姓名和虚构编号WARRANT-TEST-004的通缉令截图，声称要把全部存款转到安全账户接受资金审查，并要求持续打开屏幕共享。"),
            ("你安装了什么软件，进行了哪些操作？", "我按短信链接https://meeting.example.test/case004下载会议协查测试版APP，安装包名meeting-test-004.apk，登录账号user_meeting_test_004，并开启屏幕共享和麦克风权限。"),
            ("第一次转账时你在哪里，当时有哪些人在场？", "2026年7月13日10时42分，我独自到测试银行和平支行ATM区，使用银行卡和手机操作。当时大厅有测试银行工作人员甲，工作人员问我用途，我按对方要求说是给亲属转账。"),
            ("请说明第一笔转账的付款卡、收款账户、金额和流水号。", "我使用测试银行借记卡6222020200004234570，于10时48分通过ATM转账60000元至测试收款卡6222020200001111404，户名高模拟，流水号：TEST202607130401。"),
            ("第二笔转账的具体情况是什么？", "11时16分，我仍在ATM区转账40000元至测试收款卡6222020200001112405，户名马会例，流水号：TEST202607130402。"),
            ("总损失、返还及止付冻结情况如何？", "两笔共转出100000元，没有返还。女儿发现后于15时52分联系测试银行，银行反馈第一账户已转出，第二账户测试性冻结20000元，止付编号STOP-TEST-004。"),
            ("涉案手机、银行卡和安装包目前在哪里，能否提取查验？", "测试手机TEST-PHONE-004和银行卡6222020200004234570都由我带来，可以依法提取查验；会议APP已经卸载，原安装包没有单独保存。"),
    ...
    InquiryRecord(
        ...
        questions=[
            ("请再次核对姓名、性别、年龄、民族、身份证号码、工作单位、住址和联系方式。", "我叫钱案例，女，42岁，回族，身份证号码110101198401260056，联系电话13500000007，在测试文化传播有限公司工作，现住测试省测试市演示区星河街50号502室。以上均为虚构测试信息。"),
            ...
            ("你使用了什么平台和账号？", "我通过链接https://trade.example.test/case005下载星河资本测试版APP，登录账号invest_user_test_005，绑定手机号13500000007，APP内显示美元、黄金和USDT投资栏目。"),
            ("第一次付款的时间、金额和账户是什么？", "2026年6月28日10时12分，我使用测试银行借记卡6222020200005234571转账10000元至测试卡6222020200002222505，户名郑模拟，流水号：TEST202606280501。"),
            ...
            ("前次你说只有三笔85000元，本次为何出现第四笔？", "这是前后陈述需要更正的地方。我前次紧张，把7月5日通过手机银行转出的20000元漏算了；第四笔收款卡为6222020200002223506，户名孙样本，流水号：TEST202607050504。"),
    ...
    InquiryRecord(
        ...
        questions=[
            ("请说明姓名、性别、年龄、民族、身份证号码、工作单位、现住址和联系电话。", "我叫孙模拟，男，29岁，苗族，身份证号码110101199703150064，联系电话13400000008，在测试智能制造有限公司工作，现住测试省测试市演示区云端街60号603室。以上均为虚构测试信息。"),
            ("是否听清权利义务告知，是否申请回避？", "已经听清，不申请回避。"),
            ("事情最初是怎样发生的？", "2026年7月16日18时22分，我在单位加班时接到号码17100000006的电话，对方自称测试电商平台客服，说我购买的耳机存在质量问题，要办理三倍退款。"),
            ...
            ("对方如何利用网贷？", "对方让我打开三个网贷测试APP，声称关闭错误开通的理赔通道，实际分别申请了20000元、30000元和15000元贷款，贷款到账我的测试银行卡6222020200006234572。"),
            ("第一笔资金转出情况是什么？", "19时06分，手机银行转账20000元至测试卡6222020200003333606，户名李模拟，流水号：TEST202607160601。"),
            ("第二笔资金转出情况是什么？", "19时18分，通过测试支付账号pay_test_006扫码支付30000元至商户merchant_test_006，交易单号：PAY-TEST-20260716-602。"),
            ("第三笔资金如何转出？", "19时31分，对方远程控制办公电脑将15000元转至测试卡6222020200003334607，户名吴案例，流水号：TEST202607160603。"),
    ...
    InquiryRecord(
        ...
        questions=[
            ("请说明姓名、性别、年龄、民族、身份证号码、工作单位、住址和联系电话。", "我叫吴样本，男，55岁，汉族，身份证号码110101197108080072，联系电话13300000009，在测试建筑设计院工作，现住测试省测试市演示区金桥街70号704室。以上均为虚构测试信息。"),
            ("是否听清权利义务告知？", "已经听清，不申请回避。"),
            ("请简单讲述事情经过。", "2026年7月15日，我接到自称平台风控人员的电话，对方说我的账户违规，让我把资金取成现金并购买黄金交给指定人员核验，否则影响征信。"),
            ("你使用哪张银行卡取现？", "我使用测试银行借记卡6222020200007234573，开户名吴样本。"),
